...
export function LensDemoThird() {
  ...
  return (
    <div>
      <Lens>
        <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1f1d1d] to-[#1f1d1d] p-3 my-10">
  ...
  return (
    <svg
      ...
      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#1f1d1d" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#2a292cff" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#29272dff" />
      </g>
      <defs>
        <filter
